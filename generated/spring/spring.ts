...
export class spring extends ethereum.SmartContract {
  static bind(address: Address): spring {
    return new spring("spring", address);
  }
  ...
  try_mint(_amount: BigInt): ethereum.CallResult<boolean> {
